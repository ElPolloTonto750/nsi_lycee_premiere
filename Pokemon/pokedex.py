...
def pok_check(pokemon: int):
    ...
    if chart[pok_nbr]['Pokemon'] != '':
        pok_name = chart[pok_nbr]['Pokemon']
        pok_desc = chart[pok_nbr]['Description']
        desc = "Your pokemon's name is " + str(pok_name) + " and his pokedex number is #" + str(pokemon) + '. ' + str(pok_desc)
    else:
